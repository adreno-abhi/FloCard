...
namespace FloCard
{
    public partial class FloCardOld : System.Web.UI.Page
    {
        public static string flo_tx_url = "";
        public static string name = "", heading = "", email = "", phone = "", linkedin = "", profile_pic = "", qrimgsrc = "";
            ...
            while (!success)
            {
                if (attempt <= 10)
                {
                    ...
                    try
                    {
                        ...
                        response = Call_Service_Get("http://103.195.255.38/FloApi.svc/getrawtransaction/" + tranid);
                        ...
                        string qrcode_url = "http://bcard.366pi.tech/FloCard.aspx?id=" + tranid;
