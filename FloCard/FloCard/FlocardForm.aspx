          ...
          <div class="card card-login">
            <form class="form" method="" action="" runat="server">
              <div class="card-header card-header-primary text-center">
                <h4 class="card-title">FloCard Details  <img src="assets/img/logo-v2.png" height="40" class="pull-right" style="padding-right: 30px;" /></h4>
              ...
              <div class="footer text-center">
                <a href="#" class="btn btn-linkedin btn-raised" style="padding-bottom: 10px;" id="btnSubmit" runat="server" onserverclick="btnSubmit_Click">
				Create FloCard
				</a>
              </div>
            </form>
